...
from modules.normalization.layer import LayerNormalization
...
class TestLayerNormalization(TestCase):
    def test_first_step(self):
        ...
        expected = torch.Tensor(
            [[[0.0, -1.22474487, 1.22474487], [1.41421356, -0.707106781, -0.707106781]]]
        )
    ...
    def test_save_load(self):
        ...
        model_path = os.path.join(
            tempfile.gettempdir(), "test_layer_normalization_%f.pth" % random.random()
        )
